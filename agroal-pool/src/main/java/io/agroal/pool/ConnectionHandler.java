...
public final class ConnectionHandler implements TransactionAware {
    ...
    // task for flush this connection when it gets over it's lifetime
    private ScheduledFuture<?> lifetimeFuture;
    ...
    public void closeConnection() throws SQLException {
        if ( lifetimeFuture != null ) {
            lifetimeFuture.cancel( false );
            lifetimeFuture = null;
        }
        try {
    ...
    public void setLifetimeFuture(ScheduledFuture<?> lifetimeFuture) {
        this.lifetimeFuture = lifetimeFuture;
    }
