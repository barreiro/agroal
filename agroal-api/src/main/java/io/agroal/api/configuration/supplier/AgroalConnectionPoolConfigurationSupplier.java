...
public class AgroalConnectionPoolConfigurationSupplier implements Supplier<AgroalConnectionPoolConfiguration> {
    ...
    private boolean aggressiveReap = false;
    ...
    public AgroalConnectionPoolConfigurationSupplier(AgroalConnectionPoolConfiguration existingConfiguration) {
        ...
        this.aggressiveReap = existingConfiguration.aggressiveReap();
    ...
    public AgroalConnectionPoolConfigurationSupplier aggressiveReap() {
        checkLock();
        aggressiveReap = true;
        return this;
    }

    public AgroalConnectionPoolConfigurationSupplier aggressiveReap(boolean reap) {
        checkLock();
        aggressiveReap = reap;
        return this;
    }
    ...
    public AgroalConnectionPoolConfiguration get() {
        ...
        return new AgroalConnectionPoolConfiguration() {
            ...
            @Override
            public boolean aggressiveReap() {
                return aggressiveReap;
            }
