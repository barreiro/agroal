...
public class AgroalConnectionPoolConfigurationSupplier implements Supplier<AgroalConnectionPoolConfiguration> {
    ...
    private Duration lifetime = ZERO;
    ...
    public AgroalConnectionPoolConfigurationSupplier(AgroalConnectionPoolConfiguration existingConfiguration) {
        ...
        this.lifetime = existingConfiguration.lifetime();
    ...
    public AgroalConnectionPoolConfigurationSupplier lifetime(Duration time) {
        checkLock();
        lifetime = time;
        return this;
    }
    ...
    private void validate() {
        ...
        if ( lifetime.isNegative() ) {
            throw new IllegalArgumentException( "Lifetime must not be negative" );
        }
