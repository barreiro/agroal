...
public class AgroalPropertiesReader implements Supplier<AgroalDataSourceConfiguration> {
    ...
    public static final String LIFETIME_MS = "lifetime_ms";
    public static final String LIFETIME_S = "lifetime_s";
    public static final String LIFETIME_M = "lifetime_m";
    ...
    public AgroalPropertiesReader readProperties(Map<String, String> properties) {
        ...
        apply( connectionPoolSupplier::lifetime, Duration::parse, properties, LIFETIME );
        apply( connectionPoolSupplier::lifetime, this::parseDurationMs, properties, LIFETIME_MS );
        apply( connectionPoolSupplier::lifetime, this::parseDurationS, properties, LIFETIME_S );
        apply( connectionPoolSupplier::lifetime, this::parseDurationM, properties, LIFETIME_M );
