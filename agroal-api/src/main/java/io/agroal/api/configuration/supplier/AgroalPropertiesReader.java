...
public class AgroalPropertiesReader implements Supplier<AgroalDataSourceConfiguration> {
    ...
    public static final String ACQUIRE_SQL = "acquireSQL";
    public static final String RETURN_SQL = "returnSQL";
    ...
    public AgroalPropertiesReader readProperties(Map<String, String> properties) {
        ...
        apply( connectionPoolSupplier::acquireSql, identity(), properties, ACQUIRE_SQL );
        apply( connectionPoolSupplier::returnSql, identity(), properties, RETURN_SQL );
